...
export const userSchema = z.object({
  id: z.number().int(),
  username:
    z.string({ [requiredError]: 'Username deve ser preenchido' })
      .min(3, { message: 'Username deve possuir ao menos 3 caracteres' }),
  password:
    z.string().min(8, { message: 'Password deve possuir ao menos 8 caracteres' })
      .regex(
        REGEX_PASSWORD,
...
export type SimpleUser = z.infer<typeof getUserBalanceSchema>;
export type ReqUser = z.infer<typeof userCreateSchemaResponse>;
